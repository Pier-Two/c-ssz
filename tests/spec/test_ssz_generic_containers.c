...
#ifndef TESTS_DIR
#define TESTS_DIR "tests/fixtures/general/phase0/ssz_generic/containers"
#endif
...
static const value_type_t TYPE_LIST_UINT16_128 = {
    .kind = TYPE_LIST,
    .elem_type = &TYPE_UINT16_T,
    .param = 128u,
};

static const value_type_t TYPE_BYTE_LIST_256 = {
    .kind = TYPE_BYTE_LIST,
    .param = 256u,
};

static const value_type_t TYPE_BITLIST_5 = {
    .kind = TYPE_BITLIST,
    .param = 5u,
};

static const value_type_t TYPE_BITLIST_6 = {
    .kind = TYPE_BITLIST,
    .param = 6u,
};

static const value_type_t TYPE_BITLIST_256 = {
    .kind = TYPE_BITLIST,
    .param = 256u,
};

static const value_type_t TYPE_BITLIST_257 = {
    .kind = TYPE_BITLIST,
    .param = 257u,
};

static const value_type_t TYPE_BITLIST_1280 = {
    .kind = TYPE_BITLIST,
    .param = 1280u,
};

static const value_type_t TYPE_BITLIST_1281 = {
    .kind = TYPE_BITLIST,
    .param = 1281u,
};

static const value_type_t TYPE_BITVECTOR_1 = {
    .kind = TYPE_BITVECTOR,
    .param = 1u,
};

static const value_type_t TYPE_BITVECTOR_2 = {
    .kind = TYPE_BITVECTOR,
    .param = 2u,
};

static const value_type_t TYPE_BITVECTOR_8 = {
    .kind = TYPE_BITVECTOR,
    .param = 8u,
};

static const value_type_t TYPE_BITVECTOR_256 = {
    .kind = TYPE_BITVECTOR,
    .param = 256u,
};

static const value_type_t TYPE_BITVECTOR_257 = {
    .kind = TYPE_BITVECTOR,
    .param = 257u,
};

static const value_type_t TYPE_BITVECTOR_1280 = {
    .kind = TYPE_BITVECTOR,
    .param = 1280u,
};

static const value_type_t TYPE_BITVECTOR_1281 = {
    .kind = TYPE_BITVECTOR,
    .param = 1281u,
};
...
static const value_type_t TYPE_PROGRESSIVE_LIST_U8 = {
    .kind = TYPE_PROGRESSIVE_LIST,
    .elem_type = &TYPE_UINT8_T,
    .param = SSZ_NO_LIMIT,
};
...
static const container_def_t CONTAINER_SINGLE;
static const value_type_t TYPE_CONTAINER_SINGLE;
static const container_def_t CONTAINER_SMALL;
static const value_type_t TYPE_CONTAINER_SMALL;
static const container_def_t CONTAINER_FIXED;
static const value_type_t TYPE_CONTAINER_FIXED;
static const container_def_t CONTAINER_VAR;
static const value_type_t TYPE_CONTAINER_VAR;
static const container_def_t CONTAINER_COMPLEX;
static const value_type_t TYPE_CONTAINER_COMPLEX;
static const container_def_t CONTAINER_PROGRESSIVE_TEST;
static const value_type_t TYPE_CONTAINER_PROGRESSIVE_TEST;
static const container_def_t CONTAINER_BITS;
static const value_type_t TYPE_CONTAINER_BITS;
static const container_def_t CONTAINER_PROGRESSIVE_BITS;
static const value_type_t TYPE_CONTAINER_PROGRESSIVE_BITS;

static const value_type_t TYPE_VECTOR_FIXED_4 = {
    .kind = TYPE_VECTOR,
    .elem_type = &TYPE_CONTAINER_FIXED,
    .param = 4u,
};

static const value_type_t TYPE_VECTOR_VAR_2 = {
    .kind = TYPE_VECTOR,
...
static const field_def_t FIELDS_SINGLE[] = {
    {"A", &TYPE_UINT8_T},
};
...
static const field_def_t FIELDS_FIXED[] = {
    {"A", &TYPE_UINT8_T},
    {"B", &TYPE_UINT64_T},
    {"C", &TYPE_UINT32_T},
};
...
static const field_def_t FIELDS_VAR[] = {
    {"A", &TYPE_UINT16_T},
    {"B", &TYPE_LIST_UINT16_1024},
    {"C", &TYPE_UINT8_T},
};

static const field_def_t FIELDS_COMPLEX[] = {
    {"A", &TYPE_UINT16_T},
    {"B", &TYPE_LIST_UINT16_128},
    {"C", &TYPE_UINT8_T},
    {"D", &TYPE_BYTE_LIST_256},
    {"E", &TYPE_CONTAINER_VAR},
    {"F", &TYPE_VECTOR_FIXED_4},
    {"G", &TYPE_VECTOR_VAR_2},
};

static const field_def_t FIELDS_PROGRESSIVE_TEST[] = {
    {"A", &TYPE_PROGRESSIVE_LIST_U8},
    {"B", &TYPE_PROGRESSIVE_LIST_U64},
    {"C", &TYPE_PROGRESSIVE_LIST_SMALL},
    {"D", &TYPE_PROGRESSIVE_LIST_PROGRESSIVE_VAR},
};

static const field_def_t FIELDS_BITS[] = {
    {"A", &TYPE_BITLIST_5},
    {"B", &TYPE_BITVECTOR_2},
    {"C", &TYPE_BITVECTOR_1},
    {"D", &TYPE_BITLIST_6},
...
static const field_def_t FIELDS_PROGRESSIVE_BITS[] = {
    {"A", &TYPE_BITVECTOR_256},
    {"B", &TYPE_BITLIST_256},
    {"C", &TYPE_PROGRESSIVE_BITLIST_T},
    {"D", &TYPE_BITVECTOR_257},
    {"E", &TYPE_BITLIST_257},
    {"F", &TYPE_PROGRESSIVE_BITLIST_T},
    {"G", &TYPE_BITVECTOR_1280},
    {"H", &TYPE_BITLIST_1280},
    {"I", &TYPE_PROGRESSIVE_BITLIST_T},
    {"J", &TYPE_BITVECTOR_1281},
    {"K", &TYPE_BITLIST_1281},
    {"L", &TYPE_PROGRESSIVE_BITLIST_T},
};

static const container_def_t CONTAINER_SINGLE = {
    .name = "SingleFieldTestStruct",
...
static const container_def_t CONTAINER_COMPLEX = {
    ...
    .fields = FIELDS_COMPLEX,
    .field_count = 7u,
};

static const container_def_t CONTAINER_PROGRESSIVE_TEST = {
    .name = "ProgressiveTestStruct",
    .fields = FIELDS_PROGRESSIVE_TEST,
    .field_count = 4u,
};
...
static const container_def_t CONTAINER_PROGRESSIVE_BITS = {
    ...
    .fields = FIELDS_PROGRESSIVE_BITS,
    .field_count = 12u,
};
...
static const value_type_t TYPE_CONTAINER_COMPLEX = {
    .kind = TYPE_CONTAINER,
    .container = &CONTAINER_COMPLEX,
};

static const value_type_t TYPE_CONTAINER_PROGRESSIVE_TEST = {
    .kind = TYPE_CONTAINER,
    .container = &CONTAINER_PROGRESSIVE_TEST,
};
...
static const value_type_t TYPE_CONTAINER_PROGRESSIVE_BITS = {
    .kind = TYPE_CONTAINER,
    .container = &CONTAINER_PROGRESSIVE_BITS,
};
...
static const value_type_t *container_type_from_name(const char *name)
{
    ...
    if (strcmp(name, CONTAINER_SINGLE.name) == 0)
    {
        return &TYPE_CONTAINER_SINGLE;
    }
    if (strcmp(name, CONTAINER_SMALL.name) == 0)
    {
        return &TYPE_CONTAINER_SMALL;
    }
    if (strcmp(name, CONTAINER_FIXED.name) == 0)
    {
        return &TYPE_CONTAINER_FIXED;
    }
    if (strcmp(name, CONTAINER_VAR.name) == 0)
    {
        return &TYPE_CONTAINER_VAR;
    }
    if (strcmp(name, CONTAINER_COMPLEX.name) == 0)
    {
        return &TYPE_CONTAINER_COMPLEX;
    }
    if (strcmp(name, CONTAINER_PROGRESSIVE_TEST.name) == 0)
    {
        return &TYPE_CONTAINER_PROGRESSIVE_TEST;
    }
    if (strcmp(name, CONTAINER_BITS.name) == 0)
    {
        return &TYPE_CONTAINER_BITS;
    }
    if (strcmp(name, CONTAINER_PROGRESSIVE_BITS.name) == 0)
    {
        return &TYPE_CONTAINER_PROGRESSIVE_BITS;
    }
...
int main(void)
{
    ...
    {
        int rc = spec_report_print("ssz_generic/containers", &report);

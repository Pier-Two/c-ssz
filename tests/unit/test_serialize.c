    ...
    size_t *out_written)
{
    ...
    if ((script == NULL) || (out_written == NULL) || (script->lengths == NULL) || (script->errors == NULL))
    {
        return SSZ_ERR_INVALID_ARGUMENT;
    }
...
static bool test_serialize_basic_types_and_aliases(void)
{
    ...
    ASSERT_MEM_EQ(u64,
                  ((const uint8_t[8]){0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x02, 0x01}),
                  8u);

    ASSERT_ERR(ssz_serialize_uint128(in128, u128), SSZ_SUCCESS);
    ASSERT_MEM_EQ(u128, in128, sizeof(in128));

    ASSERT_ERR(ssz_serialize_uint256(in256, u256), SSZ_SUCCESS);
...
static bool test_serialize_bitvector_and_padding_validation(void)
{
    ...
    ASSERT_ERR(ssz_serialize_bitvector(valid_bits, sizeof(valid_bits), 10u, NULL, 0u, &out_len),
               SSZ_SUCCESS);
    ASSERT_TRUE(out_len == 2u);

    ASSERT_ERR(ssz_serialize_bitvector(valid_bits, sizeof(valid_bits), 10u, out, sizeof(out), &out_len),
               SSZ_SUCCESS);
    ASSERT_TRUE(out_len == 2u);
    ASSERT_MEM_EQ(out, valid_bits, 2u);

    ASSERT_ERR(ssz_serialize_bitvector(invalid_bits,
                                       sizeof(invalid_bits),
                                       10u,
                                       out,
                                       sizeof(out),
...
static bool test_serialize_bitlist_delimiter_and_limit(void)
{
    ...
    ASSERT_ERR(ssz_serialize_bitlist(bits, sizeof(bits), 10u, 10u, NULL, 0u, &out_len), SSZ_SUCCESS);
    ASSERT_TRUE(out_len == 2u);

    ASSERT_ERR(ssz_serialize_bitlist(bits, sizeof(bits), 10u, 10u, out, sizeof(out), &out_len),
               SSZ_SUCCESS);
    ASSERT_TRUE(out_len == 2u);
    ASSERT_MEM_EQ(out, ((const uint8_t[2]){0xAAu, 0x06u}), 2u);

    ASSERT_ERR(ssz_serialize_bitlist(bits, sizeof(bits), 10u, 9u, out, sizeof(out), &out_len),
...
static bool test_serialize_vector_fixed_and_size_query(void)
{
    ...
    ASSERT_ERR(
        ssz_serialize_vector_fixed(elements, 3u, 2u, out, sizeof(out), &out_len), SSZ_SUCCESS);
    ASSERT_TRUE(out_len == sizeof(elements));
...
static bool test_serialize_list_fixed_and_limits(void)
{
    ...
    ASSERT_ERR(ssz_serialize_list_fixed(elements, 2u, 2u, 2u, out, sizeof(out), &out_len),
               SSZ_SUCCESS);
    ASSERT_TRUE(out_len == sizeof(elements));
    ASSERT_MEM_EQ(out, elements, sizeof(elements));

    ASSERT_ERR(ssz_serialize_list_fixed(elements, 2u, 1u, 2u, out, sizeof(out), &out_len),
               SSZ_ERR_LIMIT_EXCEEDED);
...
static bool test_serialize_list_variable_and_limits(void)
{
    ...
    ASSERT_ERR(ssz_serialize_list_variable(2u, 3u, &codec, out, sizeof(out), &out_len), SSZ_SUCCESS);
    ASSERT_TRUE(out_len == 11u);
    ASSERT_MEM_EQ(out,
                  ((const uint8_t[11]){
    ...
    ASSERT_ERR(ssz_serialize_list_variable(2u, 1u, &codec, out, sizeof(out), &out_len),
               SSZ_ERR_LIMIT_EXCEEDED);
...
static bool test_serialize_container_mixed_fields_and_size_query(void)
{
    ...
    ASSERT_ERR(ssz_serialize_container(field_fixed_sizes, 3u, &codec, NULL, 0u, &out_len), SSZ_SUCCESS);
    ASSERT_TRUE(out_len == 10u);

    ASSERT_ERR(ssz_serialize_container(field_fixed_sizes, 3u, &codec, out, sizeof(out), &out_len),
               SSZ_SUCCESS);
    ASSERT_TRUE(out_len == 10u);
    ASSERT_MEM_EQ(out,
                  ((const uint8_t[10]){
...
static bool test_serialize_union_none_normal_and_size_query(void)
{
    ...
    ASSERT_ERR(ssz_serialize_union(0u, 3u, true, &forbidden_codec, NULL, 0u, &out_len), SSZ_SUCCESS);
    ASSERT_TRUE(out_len == 1u);

    ASSERT_ERR(ssz_serialize_union(0u, 3u, true, &forbidden_codec, out, sizeof(out), &out_len),
               SSZ_SUCCESS);
    ASSERT_TRUE(out_len == 1u);
...
static bool test_serialize_compatible_union_valid_and_invalid_selectors(void)
{
    ...
    ASSERT_ERR(ssz_serialize_compatible_union(7u,
                                              allowed,
                                              sizeof(allowed),
                                              &codec,
                                              NULL,
    ...
    ASSERT_ERR(ssz_serialize_compatible_union(0u,
                                              allowed,
                                              sizeof(allowed),
                                              &codec,
                                              out,
    ...
    ASSERT_ERR(ssz_serialize_compatible_union(200u,
                                              allowed,
                                              sizeof(allowed),
                                              &codec,
                                              out,
                                              ...
                                              &out_len),
               SSZ_ERR_SELECTOR_INVALID);
    ASSERT_ERR(ssz_serialize_compatible_union(3u,
                                              allowed,
                                              sizeof(allowed),
                                              &codec,
                                              out,
...
static bool test_serialize_error_cases(void)
{
    ...
    ASSERT_ERR(ssz_serialize_uint128(in128, NULL), SSZ_ERR_INVALID_ARGUMENT);
    ASSERT_ERR(ssz_serialize_uint256(in256, NULL), SSZ_ERR_INVALID_ARGUMENT);
    ASSERT_ERR(ssz_serialize_boolean(1u, NULL), SSZ_ERR_INVALID_ARGUMENT);

    ASSERT_ERR(ssz_serialize_uint128(NULL, out128), SSZ_ERR_INVALID_ARGUMENT);
    ASSERT_ERR(ssz_serialize_uint256(NULL, out256), SSZ_ERR_INVALID_ARGUMENT);

    size_t out_len = 0u;
    ASSERT_ERR(ssz_serialize_vector_fixed((const uint8_t[]){0x01u, 0x02u, 0x03u, 0x04u, 0x05u, 0x06u},
                                          3u,
                                          2u,
                                          out32,
                                          sizeof(out32),
    ...
    ASSERT_ERR(ssz_serialize_vector_fixed((const uint8_t[]){0x01u}, 0u, 1u, &out8, 1u, &out_len),
               SSZ_ERR_SCHEMA_INVALID);

    ASSERT_ERR(ssz_serialize_bitvector((const uint8_t[]){0x00u}, 1u, 0u, &out8, 1u, &out_len),
               SSZ_ERR_SCHEMA_INVALID);

    ASSERT_ERR(ssz_serialize_vector_fixed((const uint8_t[]){0x00u}, 1u, 1u, &out8, 1u, NULL),
...
static bool test_serialize_bitvector_and_bitlist_error_paths(void)
{
    ...
    ASSERT_ERR(
        ssz_serialize_bitvector(bitvector_ok, sizeof(bitvector_ok), UINT64_MAX, out, sizeof(out), &out_len),
        SSZ_ERR_OVERFLOW);
    ASSERT_ERR(ssz_serialize_bitvector(NULL, 0u, 8u, out, sizeof(out), &out_len),
               SSZ_ERR_INVALID_ARGUMENT);
    ASSERT_ERR(
    ...
    ASSERT_ERR(
        ssz_serialize_bitlist(bitvector_ok, sizeof(bitvector_ok), UINT64_MAX, SSZ_NO_LIMIT, out, sizeof(out), &out_len),
        SSZ_ERR_OVERFLOW);
    ASSERT_ERR(
        ssz_serialize_bitlist(NULL, 0u, 1u, SSZ_NO_LIMIT, out, sizeof(out), &out_len),
        SSZ_ERR_INVALID_ARGUMENT);
    ASSERT_ERR(ssz_serialize_bitlist(bitlist_bad_padding,
               ...
               SSZ_ERR_ENCODING_INVALID);
    ASSERT_ERR(
        ssz_serialize_bitlist(bitvector_ok, sizeof(bitvector_ok), 1u, SSZ_NO_LIMIT, out, sizeof(out), NULL),
        SSZ_ERR_INVALID_ARGUMENT);
...
static bool test_serialize_fixed_collection_error_paths(void)
{
    ...
    ASSERT_ERR(ssz_serialize_vector_fixed((const uint8_t[]){0x11u}, 1u, 0u, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
    ...
    ASSERT_ERR(ssz_serialize_list_fixed((const uint8_t[]){0x11u}, 1u, SSZ_NO_LIMIT, 0u, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
#if SIZE_MAX < UINT64_MAX
...
static bool test_serialize_vector_variable_error_paths(void)
{
    ...
    ASSERT_ERR(ssz_serialize_vector_variable(0u, &simple_codec, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
    ASSERT_ERR(ssz_serialize_vector_variable(1u, NULL, out, sizeof(out), &out_len), SSZ_ERR_INVALID_ARGUMENT);
#if SIZE_MAX < UINT64_MAX
    ...
    ASSERT_ERR(ssz_serialize_vector_variable(1u, &query_err_codec, out, sizeof(out), &out_len),
    ...
    ASSERT_ERR(ssz_serialize_vector_variable(1u, &add_overflow_codec, out, sizeof(out), &out_len),
               SSZ_ERR_OVERFLOW);
    ...
    ASSERT_ERR(ssz_serialize_vector_variable(1u, &uint32_overflow_codec, out, sizeof(out), &out_len),
               SSZ_ERR_OVERFLOW);
    ...
    ASSERT_ERR(ssz_serialize_vector_variable(1u, &prepare_err_codec, out, sizeof(out), NULL),
               SSZ_ERR_INVALID_ARGUMENT);
    ...
    ASSERT_ERR(ssz_serialize_vector_variable(1u, &second_query_err_codec, out, sizeof(out), &out_len),
               SSZ_ERR_TYPE_MISMATCH);
    ...
    ASSERT_ERR(ssz_serialize_vector_variable(1u, &write_err_codec, out, sizeof(out), &out_len),
               SSZ_ERR_TYPE_MISMATCH);
    ...
    ASSERT_ERR(ssz_serialize_vector_variable(1u, &mismatch_codec, out, sizeof(out), &out_len),
               SSZ_ERR_TYPE_MISMATCH);
...
static bool test_serialize_list_variable_error_paths(void)
{
    ...
    ASSERT_ERR(ssz_serialize_list_variable(1u, SSZ_NO_LIMIT, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_INVALID_ARGUMENT);
#if SIZE_MAX < UINT64_MAX
    {
        ...
        ASSERT_ERR(ssz_serialize_list_variable(UINT64_MAX, SSZ_NO_LIMIT, &codec, out, sizeof(out), &out_len),
                   SSZ_ERR_OVERFLOW);
    }
#endif
...

    {
        ...
        ssz_member_codec_t codec = make_scripted_codec(&ctx);
        ASSERT_ERR(ssz_serialize_list_variable(1u, SSZ_NO_LIMIT, &codec, out, sizeof(out), NULL),
                   SSZ_ERR_INVALID_ARGUMENT);
    }
...
static bool test_serialize_container_error_paths(void)
{
    ...
    ASSERT_ERR(ssz_serialize_container(NULL, 1u, NULL, out, sizeof(out), &out_len), SSZ_ERR_SCHEMA_INVALID);
    ASSERT_ERR(ssz_serialize_container(one_variable, 0u, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
    ASSERT_ERR(ssz_serialize_container(one_variable, 1u, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_INVALID_ARGUMENT);

    const size_t overflow_fixed_region[2] = {SIZE_MAX, 1u};
    ASSERT_ERR(ssz_serialize_container(overflow_fixed_region, 2u, &(ssz_member_codec_t){.ctx = NULL, .write = fail_if_called_write, .read = NULL, .root = NULL}, out, sizeof(out), &out_len),
               SSZ_ERR_OVERFLOW);
...

    {
        ...
        ssz_member_codec_t codec = make_scripted_codec(&ctx);
        ASSERT_ERR(ssz_serialize_container(one_variable, 1u, &codec, out, sizeof(out), NULL),
                   SSZ_ERR_INVALID_ARGUMENT);
    }
...
static bool test_serialize_union_error_paths(void)
{
    ...
    ASSERT_ERR(ssz_serialize_union(0u, 0u, false, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
    ASSERT_ERR(ssz_serialize_union(0u, 257u, false, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
    ASSERT_ERR(ssz_serialize_union(0u, 1u, true, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
    ASSERT_ERR(ssz_serialize_union(3u, 3u, false, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_SELECTOR_INVALID);
    ASSERT_ERR(ssz_serialize_union(1u, 3u, false, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_INVALID_ARGUMENT);

    {
        ...
        ssz_member_codec_t codec = make_scripted_codec(&ctx);
        ASSERT_ERR(ssz_serialize_union(1u, 3u, false, &codec, out, sizeof(out), &out_len),
                   SSZ_ERR_TYPE_MISMATCH);
    }
...

    {
        ...
        ssz_member_codec_t codec = make_scripted_codec(&ctx);
        ASSERT_ERR(ssz_serialize_union(1u, 3u, false, &codec, out, sizeof(out), NULL),
                   SSZ_ERR_INVALID_ARGUMENT);
    }
...
static bool test_serialize_compatible_union_error_paths(void)
{
    ...
    ASSERT_ERR(ssz_serialize_compatible_union(1u, NULL, 1u, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
    ASSERT_ERR(ssz_serialize_compatible_union(1u, allowed_valid, 0u, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
    ASSERT_ERR(ssz_serialize_compatible_union(1u, (const uint8_t[]){0u, 2u}, 2u, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);
    ASSERT_ERR(ssz_serialize_compatible_union(1u, (const uint8_t[]){1u, 200u}, 2u, NULL, out, sizeof(out), &out_len),
               SSZ_ERR_SCHEMA_INVALID);

    ASSERT_ERR(ssz_serialize_compatible_union(1u, allowed_valid, sizeof(allowed_valid), NULL, out, sizeof(out), &out_len),
               SSZ_ERR_INVALID_ARGUMENT);

    {
        ...
        ssz_member_codec_t codec = make_scripted_codec(&ctx);
        ASSERT_ERR(ssz_serialize_compatible_union(1u,
                                                  allowed_valid,
...
int main(void)
{
    const test_case_t tests[] = {
        ...
        {"serialize_bitvector_and_padding_validation", test_serialize_bitvector_and_padding_validation},
